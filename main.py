...
_MANIFEST = {
    "version": "1.3.1",
    "download_url": "https://github.com/RenatKost/ss/releases/download/v1.3.1/TrafficOS_Setup_v1.3.1.exe",
    "notes": "Hotfix: исправлена ошибка \"Отказано в доступе\" (код 5) при автообновлении.",
}
