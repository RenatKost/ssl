...
_MANIFEST = {
    "version": "1.1.8",
    "download_url": "https://github.com/RenatKost/ss/releases/download/v1.1.8/TrafficOS_Setup_v1.1.8.exe",
    "notes": "Исправлен мобильный доступ по LAN, исправлено обновление для пользователей старых версий",
}
